  ...
  return (
    <div>
      ...
      >
        <TypingText
          title={title}
          textStyles="font-bold text-4xl my-8 text-center text-transparent bg-clip-text  bg-gradient-to-r from-[#182C60] to-[#ffd7d7]  transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 md:text-5xl uppercase "
        />
        <TitleText
          title={subtitle}
